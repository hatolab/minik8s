...
then
    echo "Go尚未安装。正在安装Go 1.21.0..."
    # 下载Go 1.20.3版本的二进制文件
    wget --tries=0 --timeout=300 --waitretry=5 --read-timeout=20 https://mirrors.aliyun.com/golang/go1.21.0.linux-amd64.tar.gz  -O /tmp/go.tar.gz
